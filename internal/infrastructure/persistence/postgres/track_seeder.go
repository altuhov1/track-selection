	...
	tracks := []*track.Track{
		{
			...
			Requirements: []track.Requirement{
				{Subject: "math_analysis", MinGrade: 4},
				{Subject: "aig", MinGrade: 4},
				{Subject: "discrete_math", MinGrade: 4},
				{Subject: "programming", MinGrade: 3},
			},
		...
		},
		{
			...
			Requirements: []track.Requirement{
				{Subject: "programming", MinGrade: 4},
				{Subject: "algorithms_data_structures", MinGrade: 4},
				{Subject: "math_analysis", MinGrade: 3},
				{Subject: "databases", MinGrade: 3},
			},
		...
		},
		{
			...
			Requirements: []track.Requirement{
				...
				{Subject: "algorithms_data_structures", MinGrade: 3},
			},
		...
		},
		{
			...
			Requirements: []track.Requirement{
				{Subject: "programming", MinGrade: 3},
				{Subject: "databases", MinGrade: 3},
				{Subject: "informatics", MinGrade: 3},
			},
